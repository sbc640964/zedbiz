                        ...
                        <>
                            ...
                            <div className="flex space-x-4 rtl:space-x-reverse">
                                <div className="w-full">
                                    <Label value={'Value selector'}>
                                        <Input
                                            errors={errors.settings?.value_selector}
                                            className="w-full"
                                            value={data.settings?.value_selector}
                                            handleChange={e => setData('settings.value_selector', e.target.value)}
                                        />
                                    </Label>
                                </div>
                                <div className="w-full">
                                    <Label value={'Compare selector'}>
                                        <Input
                                            errors={errors.settings?.compare_selector}
                                            className="w-full"
                                            value={data.settings?.compare_selector}
                                            handleChange={e => setData('settings.compare_selector', e.target.value)}
                                        />
                                    </Label>
                                </div>
                            </div>
